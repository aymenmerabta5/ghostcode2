...
const disabled = (process.env["GHOSTCODE_DISABLE_SHARE"] ?? process.env["OPENCODE_DISABLE_SHARE"]) === "true" || (process.env["GHOSTCODE_DISABLE_SHARE"] ?? process.env["OPENCODE_DISABLE_SHARE"]) === "1"
