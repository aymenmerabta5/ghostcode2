...
export const Definitions = {
  ...
  session_interrupt_all: keybind("alt+a", "Interrupt all including subagents"),
  session_interrupt_background: keybind("alt+b", "Interrupt all background jobs"),
...
export const CommandMap = {
  ...
  session_interrupt_all: "session.interrupt.all",
  session_interrupt_background: "session.interrupt.background",
